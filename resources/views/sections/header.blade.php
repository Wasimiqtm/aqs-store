                ...
                <div class="col-sm-8">
                    <ul class="flat-unstyled">
                        ...
                        @if(Auth::check())
                            ...
                            ?>
                            <li>
                                <a href="#" title="">Available Balance :- &#163;{{number_format($totalAmountWallet,'2','.','')}}</a>
                            </li>
                            <li>
                                <a href="#" title="">Outstanding Amount :- <span  style="font-weight: bold;color: red"> &#163;{{ number_format($previousAmount,'2','.','') }} </span<
                                ></a>
                            </li>
                            @endif
                        @endif
