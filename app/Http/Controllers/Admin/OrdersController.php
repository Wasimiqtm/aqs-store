...
class OrdersController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            $orders = Transaction::whereNotNull('user_id')->with(['cart.user', 'purchasedItems.product.product_images'])->dateFilter();
            if ($id) {
                $user_id = decodeId($id);
...
//        }
    ...
    /**
     * Display a listing of the guest user orders.
     *
     * @return \Illuminate\View\View
     */
    public function guestUserOrders(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            $id = $request->input('user_id');
            $orders = Transaction::whereNull('user_id')->with(['cart.user', 'purchasedItems.product.product_images'])->dateFilter();
            if ($id) {
                $user_id = decodeId($id);
